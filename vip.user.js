...
// @version      1.0
// @description  一键破解[优酷|腾讯|爱奇艺]等VIP或会员收费视频。
// @author       Dillon
// @match    *://*.iqiyi.com/*
// @match    *://*.youku.com/*
// @match    *://v.qq.com/*
...
(() => {
  ...
  `);
  var defaultapi = {
    title: "默认用浮空解析，失效请更换接口",
    url: "http://aikan-tv.com/?url="
  };
  //apis name:显示的文字  url:接口  title:提示文字  intab:是否适合内嵌(嵌入判断:GMgetValue("replaceRaw",false)值||intab值)
  var apis =[
    {name:"我",url:"http://api.baiyug.cn/vip/index.php?url=",title:"Dillon随便看",intab:1},
    {name:"就",url:"http://aikan-tv.com/?url=",title:"Dillon随便看",intab:0},
    {name:"随",url:"http://aikan-tv.com/?url=",title:"Dillon随便看",intab:0},
    {name:"便",url:"https://jiexi.071811.cc/jx.php?url=",title:"Dillon随便看",intab:1},
    {name:"看",url:"http://q.z.vip.totv.72du.com/?url=",title:"Dillon随便看",intab:1},
    {name:"看",url:"http://aikan-tv.com/?url=",title:"Dillon随便看",intab:1}
  ];
  //嵌入页面播放
